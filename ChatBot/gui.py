...
class ChatInterface(Frame):
    ...
    def __init__(self, master=None):
        ...
        help_option.add_command(label="About Vedant's Chatterbot", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("Vedant's ChatterBot v1.0",
                                    'Vedant\'s ChatterBot is a chatbot for answering some basic questions, opening applications,etc.\nIt is based on retrival-based NLP using pythons NLTK tool-kit module\nGUI is based on Tkinter.\nUser created Neural Network helps recieve data')

    def about(self):
        tkinter.messagebox.showinfo("ChatterBot Developers",
                                    "Vedant Nichal")
...
my_img1 = ImageTk.PhotoImage(Image.open("download.jfif"))
my_label1 = Label(image=my_img1)
my_label1.pack()

a = ChatInterface(root)
root.geometry(window_size)
root.title("Vedant's ChatterBot")
